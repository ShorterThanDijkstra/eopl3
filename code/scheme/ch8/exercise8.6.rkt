...
(define the-grammar
  '((program ((arbno module-definition) expression) a-program)
    ...
    (module-body ((arbno module-definition) "[" (arbno definition) "]") defns-module-body)
...
(define interface-of
  (lambda (m-body tenv)
    (cases module-body
      m-body
      (defns-module-body (module-defs defns)
        (let ([new-tenv (add-module-defns-to-tenv module-defs tenv)])
          (simple-iface (defns-to-decls defns new-tenv)))))))
...
(define value-of-module-body
  (lambda (m-body env)
    (cases module-body
      m-body
      (defns-module-body (module-defs defns)
        (let ([new-env (add-module-defns-to-env module-defs env)])
          (simple-module (defns-to-env defns new-env)))))))
