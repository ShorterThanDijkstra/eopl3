...
(transform "+(22, (f x), 33, (g y 37))") ;;; apply, because K is proc(x) x
#|
(f x proc(v0) (g y 37 proc(v1) (K +(22, v0, 33, v1))))
|#

(transform "proc(x) +(22, (f x), 33, (g y 37))") ;;; not apply, because K is passed as second argument of proc(x k) ...
#|
proc(x k) (f x proc(v0) (g y 37 proc(v1) (k +(22, v0, 33 v1)))))
|#
