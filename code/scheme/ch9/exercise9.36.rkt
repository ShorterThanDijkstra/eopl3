...
(define initialize-class-decl!
  (lambda (c-decl)
    (cases class-decl
           ...
           (an-interface-decl (interface-name s-names method-decls) '())
           (a-class-decl
...
(define find-super-interfaces-method-tenv
  (lambda (s-names)
    (if (null? s-names)
        '()
        (let ([i-super (lookup-static-class (car s-names))])
          (cases static-class
                 i-super
                 (an-interface (method-tenv _)
                               (append method-tenv
                                       (find-super-interfaces-method-tenv
                                        (cdr s-names))))
                 (else (eopl:error 'find-super-interfaces-method-tenv)))))))
...
(define add-class-decl-to-static-class-env!
  (lambda (c-decl)
    (cases
     ...
     c-decl
     (an-interface-decl
      (i-name s-names abs-m-decls)
      (let ([m-tenv (abs-method-decls->method-tenv abs-m-decls)])
        (check-no-dups! (map car m-tenv) i-name)
        (let ([new-m-tenv
               (append m-tenv (find-super-interfaces-method-tenv s-names))])
          (eopl:pretty-print new-m-tenv)
          (newline)
          (add-static-class-binding! i-name
                                     (an-interface new-m-tenv s-names)))))
     (a-class-decl
  ...
  (lambda (sc)
    (cases static-class
           ...
           (a-static-class
            ...
            method-tenv)
           (an-interface (method-tenv s-names) method-tenv))))
    ...
    (cases
     ...
     (new-object-exp
      ...
      (let ([arg-types (types-of-exps rands tenv)]
        ...
        (cases static-class
               c
               (an-interface (method-tenv s-names)
...
(define check-class-decl!
  (lambda (c-decl)
    (cases class-decl
           c-decl
           (an-interface-decl (i-name s-names abs-method-decls) #t)
           (a-class-decl
...
(define str19
  "interface i1
   ...
   interface i2
     method int m2()
   interface i3 extends i1 extends i2
     method int m3()

   class c1 extends object implements i3
     method int initialize() 0
     method int m1() 1
     method int m2() 2
     method int m3() 3
   ...
   let o1 = new c1()
   in send o1 m3()")
(check-equal? (:t str19) (int-type))
(check-equal? (:e str19) (num-val 3))
