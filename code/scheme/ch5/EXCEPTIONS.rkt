...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;; Exception
(define report-uncaught-exception (lambda () (eopl:error "uncaught exception")))
...
(define apply-handler
  (lambda (val cont)
    (cases
     ...
     (rator-cont (rand env saved-cont) (apply-handler val saved-cont))
...
(define-datatype
 ...
 (rator-cont (rand expression?) (env environment?) (cont continuation?))
 (rand-cont (val1 expval?) (cont continuation?))
...
(define apply-cont
  (lambda (cont val)
    (cases
     ...
     (rator-cont (rand env cont) (value-of/k rand env (rand-cont val cont)))
     (rand-cont (val1 cont)
     ...
     (try-cont (var handler-exp env cont) (apply-cont cont val))
